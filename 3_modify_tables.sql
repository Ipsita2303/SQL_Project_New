...
COPY company_dim
FROM 'C:\ProgramData\Microsoft\Windows\start menu\Programs\PostgreSQL 18\company_dim.csv'
WITH (FORMAT csv, HEADER true, DELIMITER ',', ENCODING 'UTF8');

COPY skills_dim
FROM 'C:\ProgramData\Microsoft\Windows\start menu\Programs\PostgreSQL 18\skills_dim.csv'
WITH (FORMAT csv, HEADER true, DELIMITER ',', ENCODING 'UTF8');

COPY job_postings_fact
FROM 'C:\ProgramData\Microsoft\Windows\start menu\Programs\PostgreSQL 18\job_postings_fact.csv'
WITH (FORMAT csv, HEADER true, DELIMITER ',', ENCODING 'UTF8');

COPY skills_job_dim
FROM 'C:\ProgramData\Microsoft\Windows\start menu\Programs\PostgreSQL 18\skills_job_dim.csv'
WITH (FORMAT csv, HEADER true, DELIMITER ',', ENCODING 'UTF8');
